## 环境
 `conda env create -f environment.yml` 将生成一个叫做`NLGraph`的conda 环境 ，使用`conda activate NLGraph`激活此环境来运行代码。
...
## mas-scenario
机制实现的具体代码，通过`exp.py`运行机制：
`python LLMs-Auditing-Econ/mas-scenario/exp.py`
